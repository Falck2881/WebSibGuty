...
{
    navigationsBySections[index].addEventListener("click", function(urlSection, newMethodfill, urlContentSection)
    {
    ...
    }(urlSections[index], methodsFillTables[index], urlContentSections[index]), true);  
}